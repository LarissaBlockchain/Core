...
var (
	...
	neptuneFlag = flag.Bool("neptune", false, "Initializes the faucet with Neptune network config")
)
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *neptuneFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, neptuneFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
		...
		return &genesis, err
	case neptuneFlag:
		return core.DefaultNeptuneGenesisBlock(), nil
	default:
