...
func CommitGenesisState(db ethdb.Database, triedb *trie.Database, blockhash common.Hash) error {
	...
	if len(blob) != 0 {
		...
		case params.NeptuneGenesisHash:
			genesis = DefaultNeptuneGenesisBlock()
		}
		if genesis != nil {
			alloc = genesis.Alloc
		} else {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.NeptuneGenesisHash:
		return params.NeptuneChainConfig
	default:
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		GasLimit:   0x1c9c380,
		Difficulty: big.NewInt(0x5F5E100),
		Timestamp:  1705190400,
	}
}

// DefaultNeptuneGenesisBlock returns the Neptune network genesis block.
func DefaultNeptuneGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.NeptuneChainConfig,
		Nonce:      0,
		ExtraData:  []byte("Larissa Decentralizing Possibilities with LRSNode, SILO and EVM"),
		GasLimit:   0x1c9c380,
