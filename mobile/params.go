...
// NeptuneGenesis returns the JSON spec to use for the Neptune test network.
func NeptuneGenesis() string {
	enc, err := json.Marshal(core.DefaultNeptuneGenesisBlock())
	if err != nil {
		panic(err)
	}
	return string(enc)
